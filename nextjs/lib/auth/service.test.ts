...
import { buildRegistrationMaterial, rewrapVaultKey } from "@/lib/crypto/vault-key";
import { securityEvents, userSettings, users } from "@/lib/db/schema";
import { createTestUser, deriveAuthHash, TEST_PASSWORD } from "@/test/helpers/auth";
